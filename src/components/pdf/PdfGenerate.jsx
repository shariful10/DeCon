              ...
              <div className="grid grid-cols-3 mb-3">
                ...
                <div className="col-span-2 flex space-x-4">
                  <input
                    ...
                    readOnly
                    value={`${coreAndShellDPC.toFixed(0)}%`}
                  />
                </div>
              </div>
            </div>
        ...
        <div>
          ...
          <div className="border-2 border-[#c4c4c4da] pt-14 pb-10">
            <div className="w-1/2 mx-auto">
              <ProgressBar progress={(coreDPC * 100).toFixed(0)} />
            </div>
          </div>
        </div>
        <div className="pb-16">
          ...
          <div className="border-2 border-[#c4c4c4da] pt-14 pb-10">
            <div className="w-1/2 mx-auto">
              <ProgressBar progress={(shellDPC * 100).toFixed(0)} />
            </div>
          </div>
        </div>
        <div className="pt-5">
