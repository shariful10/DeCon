      ...
      >
        <div className="appearance-none w-full py-3 pl-3 pr-10 text-base leading-6 text-black bg-peach-200 border-[2px] border-black focus:outline-none focus:shadow-outline-blue focus:border-blue-300 bg-[#FBE4D4]">
          ...
          {expandOptions && (
            ...
            >
              <span onClick={expandDropdown}>Dry connection</span>
              <span onClick={expandDropdown}>Click connection</span>
              <span onClick={expandDropdown}>Velcro connection</span>
              <span onClick={expandDropdown}>Magnetic connection</span>
              <span onClick={expandDropdown}>Ferry connection</span>
              <span onClick={expandDropdown}>Corner connections</span>
              <span onClick={expandDropdown}>Screw connection</span>
            </div>
          )}
        </div>
